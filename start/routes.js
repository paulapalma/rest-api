...
Route.get('/', () => {
  return { greeting: 'Somos el equipo LOS ÚLTIMOS EN ENTREGAR' }
})
...
Route.group(() =>{
  ...
  Route.get('proyectos/:id/members', 'MemberController.index').middleware('auth')
  Route.post('proyectos/:id/members', 'MemberController.create').middleware('auth')
